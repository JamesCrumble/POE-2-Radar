...
public class WorldPathSettings
{
    ...
    public ColorNode DefaultPathColor { get; set; } = new ColorNode((uint)Color.Red.ToAbgr());
...
public class PathfindingSettings
{
    ...
    public ColorNode DefaultMapPathColor { get; set; } = new ColorNode((uint)Color.Green.ToAbgr());
    ...
    public ColorNode TargetNameColor { get; set; } = new ColorNode((uint)Color.Violet.ToAbgr());
